...
import { ScanSearch, Upload, X, Image, Video, AlertTriangle, Users, Shield, Gauge, Activity, Zap, Eye, Layers } from 'lucide-react';
...
export default function MediaDetection() {
    ...
    const runDetection = useCallback(async () => {
        ...
        try {
            const res = await detectApi.uploadFile(file);
                                    ...
                                    {currentResult && (
                                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-bg-primary/90 to-transparent py-2.5 px-4">
                                            <div className="flex items-center justify-between text-[10px] text-text-muted font-mono">
                                                <span>Model: YOLOv8n | Inference: {currentResult.inference_time_ms.toFixed(0)}ms</span>
